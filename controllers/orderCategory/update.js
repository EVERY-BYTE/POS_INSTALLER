...
exports.updateOrderCategory = void 0;
...
const updateOrderCategory = async (req, res) => {
    const { error, value } = (0, validateRequest_1.validateRequest)(orderCategorySchema_1.updateOrderCategorySchema, req.body);
    if (error) {
    ...
    try {
        ...
        logger_1.default.info('Order Category updated successfully');
